...
from .models import UserBio, Profile
...
def user_bio_view(request, username):
    ...
    return render(request, 'userbio/user_bio.html',
...
def delete_profile_picture(request):
    ...
    if request.method == 'POST':
        ...
        user_bio.profile_picture = 'profile_pics/nobody.jpg'
    ...
    return render(request, 'delete_profile_picture.html',
                  {'profile': user_bio})
